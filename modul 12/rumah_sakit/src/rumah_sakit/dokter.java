...
// Memberi nama pada setiap kolom tabel
        tb.addColumn("Id Dokter");
        tb.addColumn("Nama Dokter");
        tb.addColumn("Spesialis");
        tb.addColumn("Shift");
        tabel.setModel(tb);
        try {
// Mengambil data dari database
            res = stat.executeQuery("select * from dokter");
            while (res.next()) {
...
// dua tiga sate kelinci, hallo resky budi
    ...
    private void initComponents() {
        ...
        getContentPane().add(nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 140, 164, -1));

        spesialis.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        spesialis.setForeground(new java.awt.Color(102, 102, 102));
        getContentPane().add(spesialis, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 191, 164, -1));

        shift.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        shift.setForeground(new java.awt.Color(102, 102, 102));
        getContentPane().add(shift, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 164, -1));
...
//melakukan pencarian data berdasarkan primary key pada tabel
            res = stat.executeQuery("select * from dokter where " + "id='" + id.getText() + "'"
            );

            while (res.next()) {
                nama.setText(res.getString("nama"));
                spesialis.setText(res.getString("spesialis"));
                shift.setText(res.getString("shift"));
            }
