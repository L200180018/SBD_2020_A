...
// dua tiga sate kelinci, hallo resky budi
                tb.addRow(new Object[]{
                    res.getInt("id_pasien"),
                    res.getString("nama"),
                    res.getString("penyakit"),
                    res.getString("type")
                });
            }
    ...
    private void initComponents() {
        ...
        penyakit.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        penyakit.setForeground(new java.awt.Color(102, 102, 102));
        getContentPane().add(penyakit, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 191, 164, -1));

        type.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        type.setForeground(new java.awt.Color(102, 102, 102));
        getContentPane().add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 164, -1));
...
//            update resky cogan level 2
            stat.executeUpdate("update pasien set "
                    + "nama='" + nama.getText() + "',"
                    + "penyakit='" + penyakit.getText() + "',"
                    + "type='" + type.getText() + "'"
                    + " where "
                    + "id_pasien='" + id.getText() + "'"
            );
            kosongkan();
            tabel();
...
//melakukan pencarian data berdasarkan primary key pada tabel
            res = stat.executeQuery("select * from pasien where " + "id_pasien='" + id.getText() + "'"
            );

            while (res.next()) {
                nama.setText(res.getString("nama"));
                penyakit.setText(res.getString("penyakit"));
